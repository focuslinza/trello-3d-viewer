...
(function (root) {
  ...
  var MAT={
    ...
    N:{u:8531.2,ost:0.15,rah:0.04,sec:null,lbl:'1мм (м2)',spec:'1250*2500*1'},
    O:{u:17440.0,ost:0.15,rah:0.04,sec:null,lbl:'2мм (м2)',spec:'1250*2500*2'},
    P:{u:5000.0,ost:0.15,rah:0.04,sec:'ЛИСТ черн',lbl:'1мм (м2)',spec:'1250*2500'},
    Q:{u:7000.0,ost:0.15,rah:0.04,sec:null,lbl:'2мм (м2)',spec:'1250*2500'},
    R:{u:11000.0,ost:0.15,rah:0.04,sec:null,lbl:'3мм (м2)',spec:'1250*2500'},
    S:{u:30000.0,ost:0.15,rah:0.04,sec:null,lbl:'8мм (м2)',spec:'1250*2500'},
    T:{u:12355.2,ost:0.15,rah:0.04,sec:'ЛИСТ 304 нерж',lbl:'0,8мм (м2)',spec:'1250*2500'},
    U:{u:13996.16,ost:0.15,rah:0.04,sec:null,lbl:'1мм (м2)',spec:'1250*2500'},
    V:{u:22435.2,ost:0.15,rah:0.04,sec:null,lbl:'1.5мм (м2)',spec:'1250*2500'},
    W:{u:29902.9158828272,ost:0.15,rah:0.04,sec:null,lbl:'2мм (м2)',spec:'1250*2500'},
    X:{u:46800.0,ost:0.15,rah:0.04,sec:null,lbl:'3мм (м2)',spec:'1250*2500'},
    Y:{u:84800.0,ost:0.15,rah:0.04,sec:null,lbl:'5мм (м2)',spec:'1000*2000'},
    Z:{u:112444.444444444,ost:0.15,rah:0.04,sec:null,lbl:'8мм (м2)',spec:'1000*2000'},
    AA:{u:23636.3636363636,ost:0.15,rah:0.04,sec:null,lbl:'1мм Рифл (м2)',spec:'1250*2500'},
    AB:{u:46329.6,ost:0.15,rah:0.04,sec:null,lbl:'3мм Рифл (м2)',spec:'250*2500'},
    AC:{u:650.0,ost:0.2,rah:0.04,sec:'ПРОФИЛЬ черн',lbl:'25*1,5(м)',spec:'25*25*1,5 '},
    AD:{u:750.0,ost:0.2,rah:0.04,sec:null,lbl:'25*1,5(м)',spec:'25*25*2 '},
    AE:{u:1000.0,ost:0.2,rah:0.04,sec:null,lbl:'40*1,5(м)',spec:'40*40*1,5 '},
    AF:{u:1200.0,ost:0.2,rah:0.04,sec:null,lbl:'40*2(м)',spec:'40*40*2 '},
    AG:{u:1900.0,ost:0.2,rah:0.04,sec:null,lbl:'60*2(м)',spec:'60*60*2 '},
    AH:{u:5100.0,ost:0.2,rah:0.04,sec:'ПРОФИЛЬ 304 нерж',lbl:'40*1,5 (п.м)',spec:'40*40*1,5'},
    AI:{u:3490.0,ost:0.2,rah:0.04,sec:null,lbl:'25*2 (п.м)',spec:'25*25*2'},
    AJ:{u:2520.0,ost:0.2,rah:0.04,sec:null,lbl:'25*1,5 (п.м)',spec:'25*25*1,5'},
    AK:{u:2180.0,ost:0.2,rah:0.04,sec:null,lbl:'20*1,5 (п.м)',spec:'20*20*1,5'},
    AL:{u:1800.0,ost:0.2,rah:0.04,sec:'ТРУБА 304 нерж',lbl:'15*1 (п.м)',spec:'д15*1,5'},
    AM:{u:1975.0,ost:0.2,rah:0.04,sec:null,lbl:'16*1,5 (п.м)',spec:'д16*1,5'},
    AN:{u:3950.0,ost:0.2,rah:0.04,sec:null,lbl:'32*2 (п.м)',spec:'д32*2'},
    AO:{u:4690.83333333333,ost:0.2,rah:0.04,sec:null,lbl:'38*2 (п.м)',spec:'д38*2'},
    AP:{u:800.0,ost:0.2,rah:0.04,sec:'ТРУБА черн',lbl:'22*2 (п.м)',spec:'д22*1,5'},
    AQ:{u:900.0,ost:0.2,rah:0.04,sec:null,lbl:'27*2 (п.м)',spec:'д27*1,5'},
    AR:{u:1200.0,ost:0.2,rah:0.04,sec:null,lbl:'32*2,5 (п.м)',spec:'д32*2,5'},
    AS:{u:3000.0,ost:0.2,rah:0.04,sec:null,lbl:'76*3 (п.м)',spec:'д76*3'},
    AT:{u:300.0,ost:0.15,rah:0.04,sec:'ПРУТ 304 нерж',lbl:'3мм (п.м)',spec:'д3'},
    AU:{u:370.0,ost:0.15,rah:0.04,sec:null,lbl:'5мм (п.м)',spec:'д5'},
    AV:{u:1550.0,ost:0.15,rah:0.04,sec:null,lbl:'8мм (п.м)',spec:'д8'},
    AW:{u:1550.0,ost:0.15,rah:0.04,sec:null,lbl:'10мм (п.м)',spec:'д10'},
    AX:{u:2015.0,ost:0.15,rah:0.04,sec:null,lbl:'12мм (п.м)',spec:'д12'},
    AY:{u:3608.0,ost:0.15,rah:0.04,sec:null,lbl:'16мм (п.м)',spec:' д16'}
  };
  ...
  var CMP={
    ...
    BA:{u:2400.0,ost:0.0,rah:0.07,m:1.0,sec:null,lbl:'100 (шт)'},
    BB:{u:1700.0,ost:0.0,rah:0.07,m:1.0,sec:null,lbl:'75 (шт)'},
    ...
    BE:{u:50.0,ost:0.0,rah:0.01,m:3.0,sec:null,lbl:'Заглушка'},
    BF:{u:20.0,ost:0.0,rah:0.01,m:3.0,sec:'КРЕПЕЖ 304 нерж',lbl:'Заклепки (шт)'},
    BG:{u:100.0,ost:0.0,rah:0.01,m:3.0,sec:null,lbl:'Болт М8*40'},
    BH:{u:205.0,ost:0.0,rah:0.01,m:3.0,sec:null,lbl:'Болт М10*50'},
    BI:{u:2815.0,ost:0.0,rah:0.01,m:3.0,sec:null,lbl:'Болт М20*200'},
    BJ:{u:20.0,ost:0.0,rah:0.01,m:3.0,sec:null,lbl:'Шайба '},
    BK:{u:40.0,ost:0.0,rah:0.01,m:3.0,sec:null,lbl:'Гайка М8'},
    BL:{u:69.0,ost:0.0,rah:0.01,m:3.0,sec:null,lbl:'Гайка М10'},
    BM:{u:510.0,ost:0.0,rah:0.01,m:3.0,sec:null,lbl:'Гайка м20'},
