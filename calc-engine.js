...
(function (root) {
  ...
  // Тарифы резки (₸/м) пересмотрены 09.2026 (лазер 1,5 кВт): толстый металл на объёме
  // давал 11–16 тыс ₸/час при себестоимости ~8–10 тыс — подняты ступени 100+ и 500+
  // для 3–16 мм; 10–16 мм на первой ступени были дешевле 8 мм — исправлено.
  var CUTBEND={0.5:[800,350,240,200],0.8:[900,375,245,205],1:[1000,400,250,210],1.5:[1200,600,480,395],2:[1220,610,500,400],3:[1300,650,550,500],4:[1400,800,750,650],5:[1700,1000,950,850],8:[1900,1250,1150,1050],10:[2400,1500,1400,1300],12:[2600,1550,1450,1350],16:[2800,1900,1800,1700]};
